...
The date variable is now mutated to POSIXlt, as it is currently a factor variable. A year-month-date American style notation was used.
...
plot(interval$interval, interval$average, 
        type="l",
        main="Time series overview of steps taken per day on each 5 minute interval",
